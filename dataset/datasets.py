...
def build_dataset(is_train, test_mode, args):
    if args.data_set == 'Kinetics-400':
        ...
        if is_train is True:
            mode = 'train'
            anno_path = os.path.join(args.anno_path, 'group_all2.csv')
        elif test_mode is True:
            mode = 'test'
            anno_path = os.path.join(args.anno_path, 'valgroup_all2.csv')
        ...
        if is_train is True:
            mode = 'train'
            anno_path = os.path.join(args.anno_path, 'group1.csv')
        elif test_mode is True:
            mode = 'test'
            anno_path = os.path.join(args.anno_path, 'val_group4.csv') 
        else:  
            mode = 'validation'
            anno_path = os.path.join(args.anno_path, 'val_group4.csv') 
