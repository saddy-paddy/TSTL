...
def pairwise_distance_torch(embeddings, device):
    ...
    print(embeddings[0],"embeddings")
    precise_embeddings = embeddings.to(dtype=torch.float32)
    print(precise_embeddings.shape, "precise_embeddings.shape")
    print("nonZero embeddings if any:", torch.sum(precise_embeddings,dim=1))
    print(precise_embeddings)
    ...
    print(pairwise_distances_squared, "pairwise distance sqaured_1")
    ...
    print(mask_offdiagonals,"mask_offdiagonals")
    print("pairwise_distances_3:",pairwise_distances)
...
def TripletSemiHardLoss(y_true, y_pred, device, margin=1.0):
    ...
    print("adjacency_not",adjacency_not)
    ...
    print("pdist_matrix_tile",pdist_matrix_tile)
    ...
    print("axis_macimums",axis_maximums)
    ...
    print("mask_positives",mask_positives)
