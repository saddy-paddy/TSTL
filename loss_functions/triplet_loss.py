...
class BatchAllTtripletLoss(nn.Module):
  ...
  def forward(self, embeddings, labels):
    ...
    #print("anchor_positive_distance",anchor_positive_dists)
    # shape: (batch_size, 1, batch_size)
    anchor_negative_dists = distance_matrix.unsqueeze(1)
    #print("anchor_negaative_distances",anchor_negative_dists)
    ...
    #print("num_positive_losses",num_positive_losses)
