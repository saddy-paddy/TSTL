...
def get_args():
    ...
    # Finetuning params
    parser.add_argument('--vmae_finetune', default=None, help='finetune from vmae checkpoint')
    parser.add_argument('--clip_finetune',default=None, help='finetune from clip checkpoint')
...
def main(args, ds_init):
    ...
    if args.composition:
        ...
        from engine_for_onemodel import train_one_epoch, validation_one_epoch, final_test, merge, final_test_individual
    ...
    if args.eval:
        ...
        #test_stats = final_test_individual(args, data_loader_test, model, device, preds_file) ## use this when testing individual expert models and selector
